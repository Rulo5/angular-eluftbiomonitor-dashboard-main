...
export let thumbHTML2 = 
`<div class="clearfix">
    <img src="./assets/img/photos/10.jpg" class="float-sm-left wd-100p wd-sm-200" alt="img">
    <img src="./assets/img/photos/11.jpg" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0" alt="img">
</div>`
export let thumbTS2 = 
`import { Component } from '@angular/core';
        ...
        <div class="img-thumbnail mb-3">
            ...
            <div class="caption">
                ...
                <div class="btn btn-list pl-0 pb-0">
                    <a href="javascript:;" class="btn ripple mb-2 mr-2 btn-primary" role="button">Button</a>
                    <a href="javascript:;" class="btn ripple mb-2 mr-2 btn-secondary" role="button">Button</a>
                </div>
            </div>
        </div>
    </div>
...
export let thumbHTML4 = 
`<div>
    <img alt="Responsive image" class="img-fluid" src="../../assets/img/media/7.jpg">
</div>`
export let thumbTS4 = 
`import { Component } from '@angular/core';
...
export let thumbHTML5 = 
`<figure class="pos-relative mg-b-0">
    <img alt="Responsive image" class="img-fit-cover" src="./assets/img/photos/12.jpg">
